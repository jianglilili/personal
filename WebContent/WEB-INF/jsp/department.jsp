...
<div id="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation"
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">部门信息管理</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		<!-- /.row -->
				...
				<form class="form-inline" method="get" 
					...
					<div class="form-group">
						...
						<select	class="form-control" id="deptName"  name="deptName">
							...
							<c:forEach items="${nameType}" var="item">
								<option value="${item.dict_id}"
								        <c:if test="${item.dict_id == deptName}"> selected</c:if>>
								    ${item.dict_item_name }
								</option>
							</c:forEach>
						</select>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<tbody>
							<c:forEach items="${page.rows}" var="row">
								<tr>
									...
									<td>${row.dept_manager}</td>
									<td>${row.dept_number}</td>
									<td>
										<a href="#" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#departmentEditDialog" onclick= "editDepartment(${row.dept_id})">修改</a>
										<a href="#" class="btn btn-danger btn-xs" onclick="deleteDepartment(${row.dept_id})">删除</a>
									</td>
								</tr>
							</c:forEach>
						</tbody>
					...
					<div class="col-md-12 text-right">
						<itheima:page url="${pageContext.request.contextPath }/department/list.action" />
					</div>
					<!-- /.panel-body -->
				</div>
				<!-- /.panel -->
